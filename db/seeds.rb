...
Listing.create!(user_id: 4,title:"Mon premier train en bois",age_id:4,category_id:1,state_id:2,price:46,description:"Rails en bois. Une locomotive et deux wagons. Décors disponibles.",header_image: '../assets/peluche-1.avif');
